...
public interface ISystemChecksRepository
{
    ...
    Task<SystemCheck?> GetLastBySystemId(Guid systemId, NpgsqlConnection? connectionnAlreadyCreated = null);
    Task Clean(NpgsqlConnection? connectionnAlreadyCreated = null);
